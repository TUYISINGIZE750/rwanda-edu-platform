"""Seed database with official TVET schools"""
import sys
import os
...
from official_tvet_schools import OFFICIAL_TVET_SCHOOLS
...
def seed_schools():
    ...
    try:
        ...
        for school_data in OFFICIAL_TVET_SCHOOLS:
            school = School(
                id=school_data["id"],
        ...
        db.commit()
        print(f"✓ Successfully seeded {len(OFFICIAL_TVET_SCHOOLS)} official TVET/TSS schools")
...
if __name__ == "__main__":
    print("Seeding official TVET/TSS schools...")
    seed_schools()
